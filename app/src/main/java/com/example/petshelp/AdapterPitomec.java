...
public class AdapterPitomec extends BaseAdapter {
    Context ctx;
    ...
    public AdapterPitomec(Context context, ArrayList<Pitomec> products) {
        ctx = context;
        objects = products;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        perehod.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(ctx, petsProfile.class);
